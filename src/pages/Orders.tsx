                ...
                <div className="space-y-3">
                  {Object.entries(itemsBySupplier).map(([supplierId, supplierItems], index) => {
                    ...
                    return (
                      <div
                        key={supplierId}
                        className="bg-card rounded-2xl border border-border/30 overflow-hidden transition-all hover:border-border/50 animate-fade-in"
                              ...
                              {supplierItems.map((item, i) => (
                                <div
                                  ...
                                  className={cn(
                                    ...
                                    i < supplierItems.length - 1 && "border-b border-border/20"
                                  )}
                                >
                                     ...
                                     {order.status === 'draft' && (
                                      hasValidWhatsApp(order.supplier?.phone || null) ? (
                                         <Button
                                          ...
                                          className="gap-1.5 rounded-xl bg-success hover:bg-success/90 shadow-lg"
                                        >
            ...
            {!cotationStep ? (
              <div className="space-y-3">
                {selectedSupplier && itemsBySupplier[selectedSupplier.id]?.map(item => (
                  <div key={item.id} className="flex items-center gap-3 p-3 rounded-2xl bg-primary/5 border border-primary/10">
