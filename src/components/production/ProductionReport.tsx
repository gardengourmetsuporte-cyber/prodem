...
export function ProductionReport({ report, totals, label, compact }: ProductionReportProps) {
  if (report.length === 0 && !label) return null;
      ...
      {!compact && (
        <div className="finance-hero-card checklist-gradient-slow rounded-2xl p-5">
          <div className="flex items-center gap-3 mb-4">
            ...
            <h3 className="text-base font-bold text-white">{label || 'Relatório de Produção'}</h3>
          </div>
